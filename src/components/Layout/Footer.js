        ...
        <>
            <div className="container">
                <footer className="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
                    ...
                    <Link to="/" className="col-md-4 d-flex align-items-center justify-content-center 
                    mb-3 mb-md-0 me-md-auto link-dark text-decoration-none">
                        <i className='bi bi-facebook'
                        style={{"color": "blueviolet","fontSize":"32px", "marginRight": "25px"}}></i>
                          <i className='bi bi-facebook'
                        style={{"color": "blueviolet","fontSize":"32px"}}></i>
                        </Link>
